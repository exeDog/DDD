...
public class OrderController
{
	...
	@ApiOperation(value = "Get specific OrderHistory in the System ", notes="Returns a particular",
				response = List.class, tags = "Order")
	@ApiResponses(value = {
    ...
    {
		return _orderService.GetOrderHistory(customerId);
    }
    ...
    {
		return _orderService.GetOrderTrackingInfo(orderId);
    }
    ...
    {
		return _orderService.PlaceOrder(placeOrderRequest);
    }
}
